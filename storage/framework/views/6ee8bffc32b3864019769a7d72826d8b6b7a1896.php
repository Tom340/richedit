            ...
            <div class="card-body">
                ...
                <form method="post" action="<?php echo e(route('store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Enter Title" value="<?php echo e($title); ?>">
                    </div>
                    <div class="form-group">
                        <label for ="body">投稿本文</label>
                        <textarea class="form-control" name="body" id="summernote" cols="30" rows="10"><?php echo e($body); ?></textarea>
                    </div>
...
</html><?php /**PATH /var/www/mishima/richedit/resources/views/create.blade.php ENDPATH**/ ?>